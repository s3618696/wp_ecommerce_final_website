            ...
            <div class="col-md-6">
              <div class="single-desc">
                <div class="middle-single">
                  <h1><a href="#" style="color:black;"><?php echo $row['product_title'];?></a></h1>
                </div>

                <div class="single-price">
                  <ul>
                    <li><span class="low-price">$ <?php echo $row['product_price']; ?></span></li>
                  </ul>
                </div>

                <div class="prod-end">
                  <a href="../resources/cart.php?add=<?php echo $row['product_id']; ?>" class="medium-button button-red add-cart"
                    >Add to Cart</a
                  >
                  <div class="clear"></div>
                </div>
